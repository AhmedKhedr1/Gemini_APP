...
const String GEMINI_API_KEY = 'AIzaSyCOUOtQfckk0SaVetaBgPwLIUTUdFuRKxs';
...
const String Supabase_url = 'https://hrfmxjawmkqkcrzxbtrl.supabase.co';
const String BotImage = 'assets/images/bot icon2.gif';
